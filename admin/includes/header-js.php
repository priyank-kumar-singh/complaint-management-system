...
<script>
    ...
    navbarTitle.setAttribute("href", "http://localhost/cms/admin/dashboard.php");

    const uid = '<?php echo $uid; ?>';
    const name = '<?php echo $fname; ?>' + ' ' + '<?php echo $lname; ?>';
    const email = '<?php echo $email; ?>';
    let dep = '<?php echo $dep; ?>';
    let designation = '<?php echo $designation; ?>';
    ...
    document.getElementById("navbar-items").innerHTML = `
        ...
        <a class="nav-link active" href="http://localhost/cms/admin">Dashboard</a>
